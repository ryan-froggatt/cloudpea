...
class VaultPatchProperties {
  ...
  /**
   * Defines the metadata of VaultPatchProperties
   *
   * @returns {object} metadata of VaultPatchProperties
   *
   */
  mapper() {
    return {
...
module.exports = VaultPatchProperties;
