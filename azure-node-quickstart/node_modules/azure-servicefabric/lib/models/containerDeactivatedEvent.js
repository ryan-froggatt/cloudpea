 ...
 */
class ContainerDeactivatedEvent extends models['ApplicationEvent'] {
  /**
   * Create a ContainerDeactivatedEvent.
  ...
  /**
   * Defines the metadata of ContainerDeactivatedEvent
   *
...
module.exports = ContainerDeactivatedEvent;
