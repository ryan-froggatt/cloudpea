 ...
 */
class ApplicationDeletedEvent extends models['ApplicationEvent'] {
  /**
   * Create a ApplicationDeletedEvent.
  ...
  /**
   * Defines the metadata of ApplicationDeletedEvent
   *
   * @returns {object} metadata of ApplicationDeletedEvent
   *
   */
  mapper() {
    return {
...
module.exports = ApplicationDeletedEvent;
