...
class NodeHealthReportExpiredEvent extends models['NodeEvent'] {
  /**
   * Create a NodeHealthReportExpiredEvent.
  ...
  /**
   * Defines the metadata of NodeHealthReportExpiredEvent
   *
   * @returns {object} metadata of NodeHealthReportExpiredEvent
   *
   */
  mapper() {
    return {
...
module.exports = NodeHealthReportExpiredEvent;
