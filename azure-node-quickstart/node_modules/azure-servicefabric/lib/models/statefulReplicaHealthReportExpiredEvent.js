...
class StatefulReplicaHealthReportExpiredEvent extends models['ReplicaEvent'] {
  /**
   * Create a StatefulReplicaHealthReportExpiredEvent.
  ...
  /**
   * Defines the metadata of StatefulReplicaHealthReportExpiredEvent
   *
   * @returns {object} metadata of StatefulReplicaHealthReportExpiredEvent
   *
   */
  mapper() {
    return {
...
module.exports = StatefulReplicaHealthReportExpiredEvent;
