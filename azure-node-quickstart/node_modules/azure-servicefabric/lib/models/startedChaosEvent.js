 ...
 */
class StartedChaosEvent extends models['ChaosEvent'] {
  /**
   * Create a StartedChaosEvent.
   * @member {object} [chaosParameters] Defines all the parameters to configure
   * a Chaos run.
   ...
   * collection of (string, string) type key-value pairs. The map can be used
   ...
   * @member {object} [chaosParameters.context.map] Describes a map that
   ...
   * @member {array} [chaosParameters.chaosTargetFilter.nodeTypeInclusionList]
  ...
  /**
   * Defines the metadata of StartedChaosEvent
   *
   * @returns {object} metadata of StartedChaosEvent
   *
   */
  mapper() {
    return {
...
module.exports = StartedChaosEvent;
