...
class ChaosRestartReplicaFaultScheduledEvent extends models['ReplicaEvent'] {
  ...
  /**
   * Defines the metadata of ChaosRestartReplicaFaultScheduledEvent
   *
   * @returns {object} metadata of ChaosRestartReplicaFaultScheduledEvent
   *
   */
  mapper() {
    return {
...
module.exports = ChaosRestartReplicaFaultScheduledEvent;
