...
class StatelessReplicaHealthReportCreatedEvent extends models['ReplicaEvent'] {
  ...
  /**
   * Defines the metadata of StatelessReplicaHealthReportCreatedEvent
   *
   * @returns {object} metadata of StatelessReplicaHealthReportCreatedEvent
   *
   */
  mapper() {
    return {
...
module.exports = StatelessReplicaHealthReportCreatedEvent;
