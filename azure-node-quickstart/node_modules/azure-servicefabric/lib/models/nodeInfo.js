...
class NodeInfo {
   ...
   * @member {string} [nodeDeactivationInfo.nodeDeactivationIntent] The intent
   ...
   * @member {string} [nodeDeactivationInfo.nodeDeactivationStatus] The status
   * of node deactivation operation. Following are the possible values.
