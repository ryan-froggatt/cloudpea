 ...
 */
class AveragePartitionLoadScalingTrigger extends models['ScalingTriggerDescription'] {
  /**
   * Create a AveragePartitionLoadScalingTrigger.
  ...
  /**
   * Defines the metadata of AveragePartitionLoadScalingTrigger
   *
   * @returns {object} metadata of AveragePartitionLoadScalingTrigger
   *
   */
  mapper() {
    return {
...
module.exports = AveragePartitionLoadScalingTrigger;
