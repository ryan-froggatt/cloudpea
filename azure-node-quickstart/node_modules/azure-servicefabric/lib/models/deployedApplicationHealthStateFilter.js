...
class DeployedApplicationHealthStateFilter {
  /**
   * Create a DeployedApplicationHealthStateFilter.
   ...
   * that specify which deployed service packages to be included in the
   * returned cluster health chunk as children of the parent deployed
   * application. The deployed service packages are returned only if the parent
  ...
  /**
   * Defines the metadata of DeployedApplicationHealthStateFilter
   *
   * @returns {object} metadata of DeployedApplicationHealthStateFilter
   *
   */
  mapper() {
    return {
        ...
        modelProperties: {
          ...
          deployedServicePackageFilters: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'DeployedServicePackageHealthStateFilterElementType',
                  type: {
                    name: 'Composite',
...
module.exports = DeployedApplicationHealthStateFilter;
