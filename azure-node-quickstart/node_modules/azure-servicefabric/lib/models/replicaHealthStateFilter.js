...
class ReplicaHealthStateFilter {
  /**
   * Create a ReplicaHealthStateFilter.
  ...
  /**
   * Defines the metadata of ReplicaHealthStateFilter
   *
   * @returns {object} metadata of ReplicaHealthStateFilter
   *
   */
  mapper() {
    return {
...
module.exports = ReplicaHealthStateFilter;
