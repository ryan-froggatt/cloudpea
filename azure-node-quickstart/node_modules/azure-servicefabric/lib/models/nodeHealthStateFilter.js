...
class NodeHealthStateFilter {
  /**
   * Create a NodeHealthStateFilter.
  ...
  /**
   * Defines the metadata of NodeHealthStateFilter
   *
   * @returns {object} metadata of NodeHealthStateFilter
   *
   */
  mapper() {
    return {
...
module.exports = NodeHealthStateFilter;
