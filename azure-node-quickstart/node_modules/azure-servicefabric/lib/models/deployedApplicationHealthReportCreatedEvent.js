 ...
 */
class DeployedApplicationHealthReportCreatedEvent extends models['ApplicationEvent'] {
  /**
   * Create a DeployedApplicationHealthReportCreatedEvent.
  ...
  /**
   * Defines the metadata of DeployedApplicationHealthReportCreatedEvent
   *
   * @returns {object} metadata of DeployedApplicationHealthReportCreatedEvent
   *
   */
  mapper() {
    return {
...
module.exports = DeployedApplicationHealthReportCreatedEvent;
