...
class DeployedStatefulServiceReplicaDetailInfo extends models['DeployedServiceReplicaDetailInfo'] {
   ...
   * @member {string} [readStatus] Specifies the access status of the
   * partition. Possible values include: 'Invalid', 'Granted',
   * 'ReconfigurationPending', 'NotPrimary', 'NoWriteQuorum'
   * @member {string} [writeStatus] Specifies the access status of the
   * partition. Possible values include: 'Invalid', 'Granted',
   * 'ReconfigurationPending', 'NotPrimary', 'NoWriteQuorum'
   ...
   * @member {object} [replicaStatus] Key value store related information for
   * the replica.
   ...
   * @member {string} [deployedServiceReplicaQueryResult.replicaRole] The role
