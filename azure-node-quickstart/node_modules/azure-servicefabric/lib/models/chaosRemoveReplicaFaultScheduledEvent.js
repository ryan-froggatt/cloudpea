 ...
 */
class ChaosRemoveReplicaFaultScheduledEvent extends models['ReplicaEvent'] {
  /**
   * Create a ChaosRemoveReplicaFaultScheduledEvent.
  ...
  /**
   * Defines the metadata of ChaosRemoveReplicaFaultScheduledEvent
   *
...
module.exports = ChaosRemoveReplicaFaultScheduledEvent;
