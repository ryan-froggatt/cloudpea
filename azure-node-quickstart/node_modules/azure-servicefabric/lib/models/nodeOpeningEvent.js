 ...
 */
class NodeOpeningEvent extends models['NodeEvent'] {
  /**
   * Create a NodeOpeningEvent.
  ...
  /**
   * Defines the metadata of NodeOpeningEvent
   *
   * @returns {object} metadata of NodeOpeningEvent
   *
   */
  mapper() {
    return {
...
module.exports = NodeOpeningEvent;
