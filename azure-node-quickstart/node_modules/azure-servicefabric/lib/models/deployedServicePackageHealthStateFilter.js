...
class DeployedServicePackageHealthStateFilter {
  /**
   * Create a DeployedServicePackageHealthStateFilter.
  ...
  /**
   * Defines the metadata of DeployedServicePackageHealthStateFilter
   *
   * @returns {object} metadata of DeployedServicePackageHealthStateFilter
   *
   */
  mapper() {
    return {
...
module.exports = DeployedServicePackageHealthStateFilter;
