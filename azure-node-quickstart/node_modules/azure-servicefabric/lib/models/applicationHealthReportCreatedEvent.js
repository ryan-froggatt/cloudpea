 ...
 */
class ApplicationHealthReportCreatedEvent extends models['ApplicationEvent'] {
  /**
   * Create a ApplicationHealthReportCreatedEvent.
  ...
  /**
   * Defines the metadata of ApplicationHealthReportCreatedEvent
   *
   * @returns {object} metadata of ApplicationHealthReportCreatedEvent
   *
   */
  mapper() {
    return {
...
module.exports = ApplicationHealthReportCreatedEvent;
