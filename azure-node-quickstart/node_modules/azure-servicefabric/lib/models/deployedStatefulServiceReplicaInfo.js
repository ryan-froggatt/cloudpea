...
class DeployedStatefulServiceReplicaInfo extends models['DeployedServiceReplicaInfo'] {
   ...
   * as a replica id.
   * @member {string} [replicaRole] The role of a replica of a stateful
   ...
   * phase of ongoing reconfiguration. If no reconfiguration is taking place
   * then this value will be "None". Possible values include: 'Unknown',
   ...
   * current ongoing reconfiguration. If no reconfiguration is taking place
   * then this value will be "None". Possible values include: 'Unknown',
