...
class NodeOpenFailedEvent extends models['NodeEvent'] {
  ...
  /**
   * Defines the metadata of NodeOpenFailedEvent
   *
   * @returns {object} metadata of NodeOpenFailedEvent
   *
   */
  mapper() {
    return {
...
module.exports = NodeOpenFailedEvent;
