...
class RestoreProgressInfo {
   ...
   * failed.
   * @member {object} [restoredEpoch] Describes the epoch at which the
   ...
   * replica set changes.
   * @member {string} [restoredEpoch.dataLossNumber] The current dataloss
  ...
  /**
   * Defines the metadata of RestoreProgressInfo
   *
   * @returns {object} metadata of RestoreProgressInfo
   *
   */
  mapper() {
    return {
...
module.exports = RestoreProgressInfo;
