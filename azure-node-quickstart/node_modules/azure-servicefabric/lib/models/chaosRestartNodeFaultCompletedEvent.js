 ...
 */
class ChaosRestartNodeFaultCompletedEvent extends models['NodeEvent'] {
  /**
  ...
  /**
   * Defines the metadata of ChaosRestartNodeFaultCompletedEvent
   *
   * @returns {object} metadata of ChaosRestartNodeFaultCompletedEvent
   *
   */
  mapper() {
    return {
...
module.exports = ChaosRestartNodeFaultCompletedEvent;
