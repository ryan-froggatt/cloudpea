...
class StatelessReplicaHealthReportExpiredEvent extends models['ReplicaEvent'] {
  ...
  /**
   * Defines the metadata of StatelessReplicaHealthReportExpiredEvent
   *
   * @returns {object} metadata of StatelessReplicaHealthReportExpiredEvent
   *
   */
  mapper() {
    return {
...
module.exports = StatelessReplicaHealthReportExpiredEvent;
