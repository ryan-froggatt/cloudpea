 ...
 */
class ContainerInstanceEvent extends models['FabricEvent'] {
  /**
   * Create a ContainerInstanceEvent.
   */
  constructor() {
    super();
  }
  ...
  /**
   * Defines the metadata of ContainerInstanceEvent
   *
   * @returns {object} metadata of ContainerInstanceEvent
   *
   */
  mapper() {
    return {
...
module.exports = ContainerInstanceEvent;
