 ...
 */
class PartitionHealthReportExpiredEvent extends models['PartitionEvent'] {
  /**
   * Create a PartitionHealthReportExpiredEvent.
  ...
  /**
   * Defines the metadata of PartitionHealthReportExpiredEvent
   *
   * @returns {object} metadata of PartitionHealthReportExpiredEvent
   *
   */
  mapper() {
    return {
...
module.exports = PartitionHealthReportExpiredEvent;
