...
class SearchGetSchemaResponse {
  /**
   * Create a SearchGetSchemaResponse.
  ...
  /**
   * Defines the metadata of SearchGetSchemaResponse
   *
   * @returns {object} metadata of SearchGetSchemaResponse
   *
   */
  mapper() {
    return {
        ...
        modelProperties: {
          ...
          value: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'SearchSchemaValueElementType',
                  type: {
                    name: 'Composite',
...
module.exports = SearchGetSchemaResponse;
