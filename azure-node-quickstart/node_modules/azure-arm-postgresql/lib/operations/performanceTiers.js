...
function _list(options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/providers/Microsoft.DBforPostgreSQL/performanceTiers';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['PerformanceTierListResult']().mapper();
...
/** Class representing a PerformanceTiers. */
class PerformanceTiers {
  /**
   * Create a PerformanceTiers.
...
module.exports = PerformanceTiers;
